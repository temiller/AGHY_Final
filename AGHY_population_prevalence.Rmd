...
This is cool. 
What I would like to do next is to fit linear models for all transition years combined with trans reduction plots dropped for 2013 (as in this fig), and plot and year random effects. I will need to code this up in JAGS because we had been doing something a little different. 
